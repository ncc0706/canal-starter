...
import io.github.ncc0706.canal.client.client.ClusterCanalClient;
...
public class ClusterClientAutoConfiguration {
    ...
    public ClusterCanalClient clusterCanalClient(MessageHandler messageHandler, CanalSimpleProperties canalSimpleProperties) {
